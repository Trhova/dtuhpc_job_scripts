#!/bin/bash
#BSUB -J "humann38_metagenomics80[1-80]"
#BSUB -q hpc
#BSUB -n 8
#BSUB -R "span[hosts=1]"
...
#BSUB -M 9GB
#BSUB -W 48:00
#BSUB -o /work3/trhova/humann_project/metagenomics_80/humann_run/logs/humann38_met80_%I_%J.out
#BSUB -e /work3/trhova/humann_project/metagenomics_80/humann_run/logs/humann38_met80_%I_%J.err
...
OUTPUT_DIR="/work3/trhova/humann_project/metagenomics_80/humann_run/output"
