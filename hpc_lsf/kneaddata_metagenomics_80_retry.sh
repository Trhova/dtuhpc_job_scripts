...
# Limit this retry script to specific samples (update list as needed)
SAMPLES_LIST=(
  "T0_L12"
  "T0_L6"
  "T0_L9"
...
SAMPLE_NAME=${SAMPLES_LIST[$((LSB_JOBINDEX-1))]}
if [ -z "$SAMPLE_NAME" ]; then
  echo "No retry sample defined for index $LSB_JOBINDEX" >&2
  exit 1
fi
